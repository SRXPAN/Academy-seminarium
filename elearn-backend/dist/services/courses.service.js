...
async function assertCanManageCourse(courseId, actor) {
...
async function assertCanManageSection(sectionId, actor) {
...
export async function getCourseById(courseId, actor) {
    const course = await prisma.course.findUnique({
        where: { id: courseId },
        include: {
            instructor: {
...
export async function getMyCourses(actor) {
...
export async function getPublishedCourses(query = {}) {
...
export async function createSection(actor, courseId, input) {
    await assertCanManageCourse(courseId, actor);
...
export async function createLecture(actor, sectionId, input) {
