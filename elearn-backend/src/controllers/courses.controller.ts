...
import type { CreateCourseInput, UpdateCourseInput } from '@elearn/shared'
import { 
  createCourse as createCourseService, 
  getCourseById as getCourseByIdService, 
  getMyCourses as getMyCoursesService, 
  getPublishedCourses as getPublishedCoursesService, 
...
export async function getPublishedCourses(req: Request, res: Response) {
