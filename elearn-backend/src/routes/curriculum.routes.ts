...
router.post(
  ...
  validateResource(createSectionSchema, 'body'),
  validateResource(courseIdPathParam, 'params'),
  asyncHandler(createSection)
)

router.post(
  '/sections/:sectionId/lectures',
  validateResource(createLectureSchema, 'body'),
  validateResource(sectionIdParam, 'params'),
